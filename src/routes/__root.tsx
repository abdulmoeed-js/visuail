...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Visuail — Your AI Business Analyst" },
      ...
      { property: "og:title", content: "Visuail — Your AI Business Analyst" },
      ...
      { name: "twitter:title", content: "Visuail — Your AI Business Analyst" },
